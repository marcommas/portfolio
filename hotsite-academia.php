...
<body>
	...
	<section id="portfolio" class="portfolio padding-100">
		<div class="container">
			<h1 class="titulo"> Hotsite Academia</h1>
			<div class="divider"></div>
			
			<div class="row">
				<div class="padding-40 col-md-6">
					<a href="img/hotsite-academia/hotsite2.png" data-lightbox="example-set" >
						<img class="imagemPrincipal img-responsive" src="img/hotsite-academia/hotsite2.png" alt=""/>
					</a>

					<div class="padding-10">
						<a href="img/hotsite-academia/hotsite1.png" data-lightbox="example-set" >
							<img class="imagemSecundaria col-md-4 img-responsive" src="img/hotsite-academia/hotsite1.png" alt=""/>
						</a>

						<a href="img/hotsite-academia/hotsite5.png" data-lightbox="example-set">
							<img class="imagemSecundaria col-md-4 img-responsive" src="img/hotsite-academia/hotsite5.png" alt=""/>
						</a>

						<a href="img/hotsite-academia/hotsite6.png" data-lightbox="example-set" >
							<img class="imagemSecundaria col-md-4 img-responsive" src="img/hotsite-academia/hotsite6.png" alt=""/>
						</a>
						
						<!-- Imagens escodidas, somente para a galeria  -->
						<a href="img/hotsite-academia/hotsite3.png" data-lightbox="example-set" style="display: none;"></a>

						<a href="img/hotsite-academia/hotsite4.png" data-lightbox="example-set" style="display: none;"></a>

						<a href="img/hotsite-academia/hotsite7.png" data-lightbox="example-set" style="display: none;"></a>
				...
				<div class="padding-40 col-md-6">
					...
					<h4><i class="fa fa-check"></i> Hotsite para apresentação do software de academia.</h4>
					<h4><i class="fa fa-check"></i> Galeria de imagens.</h4>

					<h4><i class="fa fa-check"></i> <a href="http://www.genialtec.com.br/actionbody/" target="_blank" class="link-descricao">Clique aqui</a> e visualize o hotsite.</h4>
